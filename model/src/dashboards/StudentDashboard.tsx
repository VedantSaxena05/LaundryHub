...
export default function StudentDashboard() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={`Welcome back${profile ? `, ${profile.name}` : ""}!`}
        description="Here's your laundry overview"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        <AnimatedCard delay={0.1} className="group hover:scale-[1.02]">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-semibold text-muted-foreground">Active Slots</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1.5 font-medium">bookings this month</p>
          </CardContent>
        </AnimatedCard>

        <AnimatedCard delay={0.2} className="group hover:scale-[1.02]">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-semibold text-muted-foreground">Bag Status</CardTitle>
          ...
          <CardContent>
            <div className="text-4xl font-extrabold font-display capitalize">{bag ? (BAG_STATUS_LABELS[bag.status] ?? bag.status) : "No bag"}</div>
            <p className="text-xs text-muted-foreground mt-1.5 font-medium">current laundry bag</p>
          </CardContent>
        </AnimatedCard>

        <AnimatedCard delay={0.3} className="group hover:scale-[1.02]">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-semibold text-muted-foreground">Block</CardTitle>
