...
export default function TodayOpsPage() {
  ...
  const stats = [
    ...
    { label: t("today.collected_count"), value: today?.bags_collected, icon: Clock, iconBg: "bg-info/10", iconColor: "text-info" },
  ];
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={t("today.title")}
        description={today?.date || new Date().toISOString().split("T")[0]}
