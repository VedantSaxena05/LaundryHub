  ...
  return (
    <div className="space-y-8">
            ...
            <Dialog open={showCreate} onOpenChange={setShowCreate}>
              ...
              <DialogContent className="rounded-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <Button onClick={handleCreate} className="w-full rounded-xl h-11 font-semibold">Register</Button>
                </div>
              </DialogContent>
            </Dialog>
          ) : undefined
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <CardContent className="pt-5">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Badge variant={d.is_active ? "default" : "secondary"} className="rounded-lg">{d.is_active ? "Active" : "Inactive"}</Badge>
        ...
        {devices.length === 0 && <p className="text-center text-muted-foreground py-12 col-span-3 font-medium">No devices registered</p>}
      </div>
    </div>
  );
}
