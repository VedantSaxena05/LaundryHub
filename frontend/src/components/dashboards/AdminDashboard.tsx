...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "Active Students", value: overview?.active_students, icon: Users, iconBg: "bg-primary/10", iconColor: "text-primary" },
    { label: "Active Staff", value: overview?.active_staff, icon: Shirt, iconBg: "bg-secondary/10", iconColor: "text-secondary" },
    { label: "Slots Booked Today", value: overview?.slots_booked_today, icon: Calendar, iconBg: "bg-info/10", iconColor: "text-info" },
    { label: "Bags In Flight", value: overview?.bags_in_flight, icon: Package, iconBg: "bg-warning/10", iconColor: "text-warning" },
  ];
        ...
        <AnimatedCard delay={0.5}>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 font-display text-lg">
              <BarChart3 className="h-5 w-5 text-primary" /> Block Usage Today
            </CardTitle>
          </CardHeader>
          <CardContent>
